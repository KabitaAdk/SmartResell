...
import { Smartphone, Eye, EyeOff, CheckCircle } from "lucide-react"
    ...
    <div className="py-16 bg-gradient-to-br from-smart-primary/10 via-white to-smart-secondary/5 flex items-center justify-center p-4 min-h-[calc(100vh-8rem)]">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Join thousands of smart phone traders</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  type="checkbox"
                  required
                  className="rounded border-gray-300 text-smart-primary focus:ring-smart-primary"
                />
                <Label htmlFor="terms" className="text-sm text-gray-600">
                  I agree to the{" "}
                  <Link href="/terms" className="text-smart-secondary hover:underline">
                    Terms of Service
                  </Link>{" "}
                  and{" "}
                  <Link href="/privacy" className="text-smart-secondary hover:underline">
                    Privacy Policy
                  </Link>
                </Label>
              </div>
