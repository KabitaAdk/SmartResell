...
$models = $conn->query("SELECT DISTINCT model FROM iphone_specs ORDER BY model");
        ...
        <div class="col-md-2">
            <select name="model" class="form-select">
                ...
                <?php while($row = $models->fetch_assoc()): ?>
                    <option value="<?php echo $row['model']; ?>" <?php if(isset($_GET['model']) && $_GET['model']==$row['model']) echo 'selected'; ?>>
                        <?php echo $row['model']; ?>
                    </option>
                <?php endwhile; ?>
            </select>
                    ...
                    <div class="card shadow-sm h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text mb-2">
                                ...
                                <strong>Description:</strong> <?php echo nl2br
